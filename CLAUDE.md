...
22. **Eén kanaal, één merk.** Een sessie gaat over [[ZekerWet]] óf over klantwerk zoals [[Back Ignition]], nooit over allebei. Statusoverzichten, takenlijsten en dagnotities in een ZekerWet-sessie noemen geen klantwerk, en andersom. Klantwerk krijgt zijn eigen wmux-pane en zijn eigen sessie; de scheiding uit regel 19 geldt ook voor wat er op het scherm en in de lijst van Ali staat (correctie 19 september 2026).
23. **De mail van Sid ([[Murmurly]], 28 augustus 2026) wordt alsnog beantwoord.** Op 16 en 19 september 2026 besloot [[Ali Can]] hem niet te beantwoorden; op 24 september 2026 herzag hij dat zelf en vroeg om een mail. Alleen op zijn verzoek eraan werken, niet uit eigen beweging voorstellen. Regels 16, 17 en 21 gelden: feiten uit het account (de 24,99 euro van 31 augustus is volledig terugbetaald, alle abonnementen zijn opgezegd), eerst de inbox, context en een dankwoord.
24. **Gmail send-as voor zekerwet-adressen: "behandelen als alias" uit.** Zo staat `support@zekerwet.nl` ingesteld en zo werkt het; met het vinkje aan behandelt Gmail het adres als tweede naam voor dezelfde bus en lekt het onderliggende Gmail-adres door in antwoorden. SMTP-instellingen overnemen van het adres dat al werkt, niet zelf bedenken. Afzendernaam is per adres: postbussen heten `ZekerWet`, koude benadering door [[Ali Can]] gaat als `Ali Can | ZekerWet`, want een bedrijfsnaam boven een persoonlijk verzoek leest als mailing (correctie 21 september 2026).
25. **Zelf agents inzetten, niet wachten tot Ali erom vraagt.** Bij onderzoek, audits, brede vragen ("wat kan beter", "zoek uit", "klopt dit") en na elke afgeronde bouwstap zet Claude uit zichzelf parallelle agents in om taken en risico's te vinden: maximaal drie per ronde en één ronde per vraag, zodat de gebruikslimiet niet halverwege de dag op is. Agents lezen alleen; bouwen blijft bij de werker-terminal in de ZekerWet-repo. Elke agentclaim die Ali doorkrijgt, is eerst door Claude zelf nagekeken met grep, een read of een live-meting, en onjuiste claims worden als zodanig gemeld. Claude sluit elke ronde af met een gerangschikte lijst en een kant-en-klare prompt voor de werker (verzoek 26 september 2026).
