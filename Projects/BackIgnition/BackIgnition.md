...
Site herbouwd volgens [[wensen-leon-2026-09-16]] en live op https://back-ignition-back-ignition.vercel.app. Sinds 18 september een one-pager zoals de oude site: embleem met vier knoppen, dan About, Jobs, Shop en Contact onder elkaar; de oude losse URL's sturen door naar het anker. Shop (Stripe) en contactformulier (Resend) zijn aangesloten. Domein gekoppeld op 17 september, Stripe-sleutel van de band staat sinds die avond in Vercel (`STRIPE_SECRET_KEY`, beperkt tot Checkout Sessions). Sinds 18 september staan de zes artikelen van de band in de shop, zie [[shop-artikelen]] voor prijzen, inkoop en marge; verzending € 8,50 NL. Alle veertig productfoto's staan er sinds die middag in. Wacht nog op: voorraadaantallen (staat op 10 per artikel), een mailadres voor het formulier, en bedrijfsgegevens voor de juridische pagina's van [[Léon van Cappellen]].
...
- 2026-09-18, middag: zes artikelen van de band in de shop (commit `6acf74b`, live). Kaarten tonen nu de omschrijving, verzending is € 8,50 binnen Nederland zonder gratis-drempel, en Checkout krijgt naam, omschrijving, foto en sku per regel mee. Live getest met een echte sessie van € 31,00 (niet betaald). Inkoopprijzen en marges in [[shop-artikelen]]. Nog nodig van de band: foto's en voorraad. Later die middag alle foto's binnen en live (`02232d0`), alleen voorraad nog.
- 2026-09-18, later: hele site weer één doorscrolbare pagina op verzoek van de band, commit `6133ca8`. Zie de dagnotitie.
- 2026-09-18: landingspagina terug naar de oude opzet op verzoek van [[Ali Can]]: blauw embleem in het midden, vier knoppen, geen tekst. Commit `fedefdf`, live. Kopie van de oude site (vorige webdesigner, admin-paneel, lege shop) opgehaald van de oude server `83.86.15.124` via SNI; archive.org heeft er niets van.
